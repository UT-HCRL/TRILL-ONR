...
from simulator.envs import BaseEnv
...
def main(gui=1, save_video=False):
    ...
    while not done:
        ...
        if '1' in pressed_keys:
            ...
            locomotion_mode = 2  # walk_backward
        elif 'y' in pressed_keys:
            locomotion_mode = 3  # walk_left
        elif 'u' in pressed_keys:
            locomotion_mode = 4  # walk_right
        elif 'i' in pressed_keys:
            locomotion_mode = 5  # walk_left_forward
        elif 'o' in pressed_keys:
            locomotion_mode = 6  # walk_right_forward
